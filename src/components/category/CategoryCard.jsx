...
function CategoryCard({data}) {
  ...
  return (
    ...
    <Link to="product">
    <div className="bg-white rounded-lg overflow-hidden shadow-md h-80">
      ...
      <div className="p-4 flex flex-wrap justify-end items-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2 ">{data&&data.products ?(data.products[0].title):""}</h3>
